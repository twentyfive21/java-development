...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (running){
            ...
            searchByLastName(dataSource, lastNameOfActor);
            ...
            searchByFullName(dataSource,firstName,lastName);
    ...
    public static void searchByFullName(DataSource dataSource, String firstName, String lastName){
        try{
